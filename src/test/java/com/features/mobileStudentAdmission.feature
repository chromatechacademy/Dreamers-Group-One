Feature: Student Admission
    ...
    Scenario: CTSMS - Student Admission
        ...
        And fills in all required Information "908748","SDET","Testing Fundamentals","Willy","Male","02/05/1980","Rob","309-492-4982"
        And clicks Save
        Then user will have created a Student and user will see "Record Saved Successfully"
        Then user deletes student records with class "SDET" and section "Testing Fundamentals" and admission no "908748"